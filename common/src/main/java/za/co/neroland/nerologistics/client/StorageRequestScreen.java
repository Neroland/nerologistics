...
/**
 * Storage request terminal screen — a procedural dark-hull panel (no texture asset), mirroring the
 * NeroTech machine-screen approach. Slot wells follow the menu's slot positions; 26.x renders container
 * screens via {@code extract*(GuiGraphicsExtractor, ...)}.
 */
public class StorageRequestScreen extends AbstractContainerScreen<StorageRequestMenu> {
    ...
    public StorageRequestScreen(StorageRequestMenu menu, Inventory playerInventory, Component title) {
